namespace MasterMind.Types
{
    public class Message
    {
        ...
        public static readonly Message PROPOSE_COMMAND = new Message("Propose Combination: ");
        public static readonly Message UNDO_COMMAND = new Message("Undo previous Proposal: ");
        public static readonly Message REDO_COMMAND = new Message("Redo previous Proposal: ");
